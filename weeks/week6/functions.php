...
echo '<h2>How do we deal with arrays? We are going to be using indexed array</h2>';
...
echo '<br>This is my area:</b> '.$my_array[0].' <br>'; 
echo '<br>This is my volume:</b> '.$my_array[1].' <br>'; 
...
echo '<br>This is my area:</b> '.$area.' <br>'; 
echo '<br>This is my volume:</b> '.$volume.' <br>'; 
